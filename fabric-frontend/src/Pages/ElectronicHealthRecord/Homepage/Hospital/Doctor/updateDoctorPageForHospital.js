...
function UpdateDoctorPageForHospital() {
  ...
  return (
    ...
    <HospitalPageHeader onCategorySelect={handleCategorySelect} selectedCategory={selectedCategory} UserType={state?.UserType} Username={state?.Username} UserID={userID}/>
