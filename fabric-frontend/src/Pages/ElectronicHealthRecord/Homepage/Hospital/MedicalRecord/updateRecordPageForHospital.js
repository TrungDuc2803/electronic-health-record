...
function UpdateRecordPageForHospital() {
  ...
  return (
    ...
    <HospitalPageHeader onCategorySelect={handleCategorySelect} selectedCategory={selectedCategory} UserType={state?.UserType} Username={state?.Username} UserID={state?.UserID}/>
